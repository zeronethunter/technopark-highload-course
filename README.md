...
- Шардирование:
    - Поля:
        - id
    - Алгоритм - естественное шардирование (id % num_shards)
...
|---------------------|----------------------|--------------------|-------------------|---------------|
| Адрес               | 300                  | 300 млн. * 103 Б   | 29 Гб             | PostgreSQL    |
...
| Kotlin                | Mobile Android     | Мировые тенденции говорят о том, что android - самая популярная операционная система для телефонов. Поэтому появляется необходимость в нативном android приложении.         |
